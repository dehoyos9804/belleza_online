        ...
        <div class="row">
            <div class="mbr-white col-lg-6 col-md-7 content-container">
                ...
                <p class="mbr-text pb-3 mbr-fonts-style display-5">
                    Si desea adquirir servicios de belleza, desde la comodidad de tu hogar, este es tu portal web, 
                    podras encontrar una variedad de servicios de bellezas con los mejores profesionales de la región. 
            ...
            <div class="col-lg-6 col-md-5">
                <div class="form-container">
                    <div class="media-container-column" data-form-type="formoid">
                      <!--<div class="alert alert-danger col-md-12 text-center">error</div>-->
                        <form action="{{route('clientes.store')}}" method="POST" class="mbr-form form-with-styler" enctype="multipart/form-data">
                            ...
                            <div class="dragArea row">
                              ...
                              <div class="col-md-12 form-group" data-for="name">
                                <div class="cid-roMVNmtAJ1 text-center">
                                  ...
                                  <input type="file" name="elegir" id="elegir" class="col-md-4" value='{{url("/admin-lte")}}/joli/assets/images/users/no-image.jpg'>
                                </div>
                              </div>
                              ...
                              <div data-for="fechanacimiento" class="col-md-12 form-group">
                                  <input type="date" name="fechanacimiento" placeholder="Fecha De Nacimiento" required="required" data-form-field="Name" class="form-control px-3 display-7" id="fechanacimiento">
                              </div>
