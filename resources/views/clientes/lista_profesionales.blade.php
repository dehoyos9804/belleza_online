...
@section('contenido')
    ...
    <div class="row">
      @foreach($varempleado as $empleado)  
        ...
        <div class="col-md-3">
            <!-- CONTACT ITEM -->
            <div class="panel panel-default" onclick="location.href='{{route("cliente.galeria_profesionales",['id'=>$varcliente->idcliente,
                'idempleado'=>$empleado->idempleado])}}';">
                <div class="panel-body profile2">
                    <div class="profile-image">
                        <img src='{{$empleado->imagen}}' alt="Samuel Leroy Jackson"/>
                    </div>
