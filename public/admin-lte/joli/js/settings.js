/*var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="css/theme-default.css"><img src="{{url("/admin-lte")}}/joli/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="css/theme-brown.css"><img src="{{url("/admin-lte")}}/joli/img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="css/theme-blue.css"><img src="{{url("/admin-lte")}}/joli/img/themes/blue.jpg"/></a>'                        
            +'<a href="#" data-theme="css/theme-white.css"><img src="{{url("/admin-lte")}}/joli/img/themes/light.jpg"/></a>'            
            +'<a href="#" data-theme="css/theme-black.css"><img src="{{url("/admin-lte")}}/joli/img/themes/black.jpg"/></a>'
        +'</div>'
