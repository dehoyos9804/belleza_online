...
<head lang="es">
  ...
  <link rel="stylesheet" href='{{url("/admin-lte")}}/assets/web/assets/mobirise-icons-bold/mobirise-icons-bold.css'>
  <link rel="stylesheet" href='{{url("/admin-lte")}}/assets/web/assets/mobirise-icons/mobirise-icons.css'>
  <link rel="stylesheet" href='{{url("/admin-lte")}}/assets/tether/tether.min.css'>
  <link rel="stylesheet" href='{{url("/admin-lte")}}/assets/bootstrap/css/bootstrap.min.css'>
  <link rel="stylesheet" href='{{url("/admin-lte")}}/assets/bootstrap/css/bootstrap-grid.min.css'>
  <link rel="stylesheet" href='{{url("/admin-lte")}}/assets/bootstrap/css/bootstrap-reboot.min.css'>
  <link rel="stylesheet" href='{{url("/admin-lte")}}/assets/socicon/css/styles.css'>
  <link rel="stylesheet" href='{{url("/admin-lte")}}/assets/dropdown/css/style.css'>
  <link rel="stylesheet" href='{{url("/admin-lte")}}/assets/theme/css/style.css'>
  <link rel="stylesheet" href='{{url("/admin-lte")}}/assets/mobirise/css/mbr-additional.css' type="text/css">
