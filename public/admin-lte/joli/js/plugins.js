    ...
    var fullCalendar = function(){
        ...
        var calendar = function(){
                ...
                var calendar = $('#calendar').fullCalendar({
                    //modifico la cabecera de mi calendario
                    header:{
                    ...
                    businessHours:{
                        ...
                        dow:[1,2,3,4,5]//0= domingo, 1= lunes, 2 = martes, 3 = miercoles, 4= jueves, 5 = viernes, 6 = sabado
                    },
                    dayClick:function(date,jsEvent,view){
                        limpiarModal();
                        $('#btnNuevaCita').prop("disabled",false);
                    ...
                    events:"http://localhost:8000/cita/eventos",
                    editable:true,
                    eventDrop:function(calEvent){
                        $('#txtId').val(calEvent.id);
                        $('#titulocita').val(calEvent.title);
                    ...
                    eventClick:function(calEvent, jsEvent, view){
                        limpiarModal();
                        $('#btnNuevaCita').prop("disabled",true);
                        ...
                        crearDetalle(calEvent.id);
                        $("#ModalEventos").modal();

                    }
                    /*events:[//permite crear eventos en un día especifico
                        {
                            id:1,
                            title:'Evento 1, llegamos a 8.000',
                            descripcion:"Programar ¡me apasiona!",
                            start:'2019-05-01',
                            color:"#f02f05",
                            textColor:"#ffffff"
                        },
                        ...
                        {
                            title:'Evento 2, Saludos',
                            descripcion:"Programar ¡me apasiona!",
                            start:'2019-05-11T12:30:00',
                            allDay:false,
                            color:"#fff000",
                            textColor:"#000000"
                        }
        ...
        var calendar2 = function(){
            var dato = $('#txtdown').val().split(' ');
            aInfo = JSON.stringify(dato);
